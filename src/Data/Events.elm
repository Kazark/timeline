...
events =
  ...
  , event (occurred <| on          1662 May 19     ) "Act of Uniformity" [Puritanism]
  , event (occurred <| duringYear  1662            ) "Half-Way Covenant" [Puritanism]
  , event (occurred <| on          1689 May 24     ) "Act of Toleration" [Puritanism]
